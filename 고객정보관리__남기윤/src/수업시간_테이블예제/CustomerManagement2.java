...
public class CustomerManagement2 extends JFrame {
	...
	class MenuMain extends JPanel implements ActionListener, ItemListener {
		...
		public void load() throws IOException {
			...
			try {
				BufferedReader read = new BufferedReader(new FileReader(loadfilename));
		...
		public void save() throws IOException {
			...
			String savefilename = fileDir +"//"+ fileName; // 선택한 파일 디렉토리 경로와 파일이름을 저장
			...
			try {
				...
				for(int i=0;i<showTable.table.getRowCount();i++){
					...
					// [오수철]. 010-1234,5678, 690121-1123456]
